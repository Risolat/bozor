  ...
  return (
    <div className="header">
      <div className="header__top container">
        <p className="header__top-text">Bozor.comга Хуш келибсиз. Иш вақти: Душ-Якш 9:00 - 17:00</p>
      ...
      <div className="header__nav">
        ...
        <div className="header__nav-input-box">
          ...
          <img src={search} alt="search" width="50" height="48" className="search"/>
        </div>
        <span><img src={login} alt="login"/></span>
